...
import zkzl.xiaofeibao.adapters.FragmentOverAdapter;
...
@ContentView(R.layout.fragment_over_layout)
public class FragmentOver extends FragmentBase {

    @ViewInject(R.id.over_pull_list_view)
    private PullToRefreshListView refreshListView;

    private FragmentOverAdapter adapter;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        adapter = new FragmentOverAdapter(getActivity());
