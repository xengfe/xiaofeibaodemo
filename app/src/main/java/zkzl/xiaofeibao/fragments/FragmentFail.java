...
import zkzl.xiaofeibao.adapters.FragmentFailAdapter;
...
@ContentView(R.layout.fragment_fail_layout)
public class FragmentFail extends FragmentBase {

    @ViewInject(R.id.fail_pull_list_view)
    private PullToRefreshListView refreshListView;

    private FragmentFailAdapter adapter;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        adapter = new FragmentFailAdapter(getActivity());
