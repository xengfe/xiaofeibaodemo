...
import zkzl.xiaofeibao.adapters.FragmentProfitAdapter;
...
@ContentView(R.layout.fragment_profit_layout)
public class FragmentProfit extends FragmentBase {

    @ViewInject(R.id.profit_pull_list_view)
    private PullToRefreshListView refreshListView;

    private FragmentProfitAdapter adapter;


    public FragmentProfit() {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        adapter = new FragmentProfitAdapter(getActivity());
