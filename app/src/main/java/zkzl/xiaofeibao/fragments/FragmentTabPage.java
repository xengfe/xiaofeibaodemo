...
import zkzl.xiaofeibao.adapters.IndicatorFragmentAdapter;
import zkzl.xiaofeibao.bean.Shop;
import zkzl.xiaofeibao.utils.DateUtils;

@ContentView(R.layout.fragment_tab_page_indicator)
public class FragmentTabPage extends FragmentBase {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        adapter = new IndicatorFragmentAdapter(getActivity());
